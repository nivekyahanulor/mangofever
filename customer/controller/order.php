...
if(isset($_POST['payment-order'])){
	...
	curl_setopt_array($curl, array(
	  ...
	  CURLOPT_POSTFIELDS => array(
		...
		'merchantlogourl' => 'https://mangofever.shop/admin/assets/logo/logo.jpg',
		'webhooksuccessurl' => 'https://mangofever.shop/customer/success.php',
		'redirectsuccessurl' => 'https://mangofever.shop/customer/success.php'
	  ),
	));
...
if(isset($_POST['checkout-order'])){
	...
	$mysqli->query("INSERT INTO pos_checkout_order (customer_id ,transcode, delivery_option,is_preorder,delivery_date,delivery_time) 
						VALUES ('$customerid','$transcode','$delivery_option','$is_preorder','$date','$time')");
